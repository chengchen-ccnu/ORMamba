...
def get_args():
    ...
    parser.add_argument('--benchmark', type = str, choices=['MTL', 'Seven' , 'FineDiving' , 'LOGO'],default='LOGO' ,  help = 'dataset')
...
def setup(args):
    args.config = 'configs/{}_ORMamba.yaml'.format(args.benchmark)
    # args.exp_name = 'try'
    args.experiment_path = os.path.join('./experiments', 'ORMamba', args.benchmark, args.exp_name)
    if args.resume:
